...
private:
  ...
  void createDistribution1D(const DataSet *dataSet, const TString &var, TH1* &h, TH1* &hUnweight, TGraphAsymmErrors* &uncert, const HistParams &histParams) const;
  ...
  void createStack1D(const DataSets &dataSets, const TString &var, std::vector<TH1*> &hists, std::vector<TH1*> &histsUnweight, std::vector<TString> &legEntries, TGraphAsymmErrors* &uncert, const HistParams &histParams) const;
  ...
  std::pair<TPaveText*, TPaveText*> header(const DataSet* ds, bool showLumi, const TString &info = "") const;
  std::pair<TPaveText*, TPaveText*> header(const DataSets &ds, bool isSimulation, bool showLumi, const TString &info = "") const;
  std::pair<TPaveText*, TPaveText*> header(bool isSimulation, bool showLumi, const TString &info = "") const;
